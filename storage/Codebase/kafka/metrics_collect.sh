...
maxLatency=$(docker exec -t -i kafka bin/kafka-producer-perf-test.sh --topic dt-imms-opcua-0 --num-records 50 --throughput 10 --producer-props bootstrap.servers=localhost:9092 --record-size 1 | cut -d, -f4|sed 's/[^0-9]*//g')
