...
#include "stack/phy/layer/LtePhyRsu.h"

Define_Module(LtePhyRsu);
...
void LtePhyRsu::initialize(int stage)
{
    if (stage == 0)
    {
    ...
    else if (stage == 1)
    {
        ...
        bdcUpdateInterval_ = getSimulation()->getModule(masterOmnetId)->getSubmodule("cellInfo")->par("positionUpdateInterval");
...
void LtePhyRsu::handleSelfMessage(cMessage *msg)
{
...
void LtePhyRsu::handleAirFrame(cMessage* msg)
{
