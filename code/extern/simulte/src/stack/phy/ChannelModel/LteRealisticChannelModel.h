...
public:
     ...
     */
    std::vector<double> getRSRP_D2D(UserControlInfo* lteInfo,std::vector<std::pair<Band,double>> rssivector);
    /*
    ...
    std::vector<std::pair<Band,double>> getRSSI(LteAirFrame *frame, UserControlInfo* lteInfo_1, MacNodeId destId, Coord destCoord, MacNodeId enbId);
