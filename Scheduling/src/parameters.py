...
class Parameters:
    ...
    def __init__(self):
        ...
        self.A2C_Ctime = {'agent':A2C, 'save_path':'job_scheduling_A2C_Ctime', 'log_dir':"/home/aicon/aluri/workspace/tensor_A2C_Ctime/",'color':'Red', 'yerrcolor':'Brown', 'title':'A2C Ctime agent', 'figure_name':'learning_curve_Ctime.png'}
        self.A2C_Slowdown = {'agent':A2C, 'save_path':'job_scheduling_A2C_Slowdown', 'log_dir':"/home/aicon/aluri/workspace/tensor_A2C_Slowdown/", 'color':'SkyBlue', 'yerrcolor':'Blue', 'title':'A2C Slowdown agent', 'figure_name':'learning_curve_Slowdown.png'}
        self.PPO2 = {'agent':PPO2, 'save_path':'job_scheduling_PPO2', 'log_dir':"/home/aicon/aluri/workspace/tensor_PPO2/", 'color':'Green', 'yerrcolor':'DarkGreen', 'title':'PPO2 agent', 'figure_name':'learning_curve_PPO2.png'}
