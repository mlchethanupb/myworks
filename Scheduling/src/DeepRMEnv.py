...
class Env(gym.Env):
    def __init__(self , pa , job_sequence_len = None , job_sequence_size = None , end = 'no_new_job') :
        ...
        action_space = 6 #[i for i in range(pa.job_wait_queue)]
        #action_space.append(9999)
        self.state_space = state_space
        self.action_space = spaces.Discrete(action_space)
        self.observation_space = spaces.Box(low=0, high=6, shape=(20,2), dtype=np.int64)
>>>>>>> 830c052bc52f7c49699180870945f69f0a9a530e
...
>>>>>>> 830c052bc52f7c49699180870945f69f0a9a530e
    ...
    def get_new_job_from_seq(self , seq_no , seq_idx) :
	    new_job = Job(resorce_requirement = self.job_sequence_size[seq_idx] ,
		              job_len = self.job_sequence_len[seq_idx] ,
