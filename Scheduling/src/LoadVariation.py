...
if __name__ == '__main__':
    ...
    models = [pa.A2C_Slowdown, pa.random, pa.PPO2]
    y_slowdown_readings = []
    ...
    for i in range(len(models)):
        ...
        for rate in cluster_load:
            ...
            pa.simu_len, pa.new_job_rate = job_distribution.compute_simulen_and_arrival_rate(cluster_load[-1]/100,pa)
            cluster_values = {}
            ...
            cluster_values['cluster_load'] = pa.cluster_occupied * 100 / pa.cluster_capacity # actual loads for which graph will be plotted
