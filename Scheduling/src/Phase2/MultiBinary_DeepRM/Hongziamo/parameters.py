...
class Parameters:
    def __init__(self):
        ...
        # self.num_ex = 10  # 1                # number of sequences
        self.num_ex = 1  # 1                # number of sequences

        self.output_freq = 10          # interval for output and store parameters

        self.num_seq_per_batch = 20  # 10    # number of sequences to compute baseline
        self.episode_max_length = 200  # enforcing an artificial terminal

        self.num_res = 2               # number of resources in the system
        self.num_nw = 10  # 5                # maximum allowed number of work in the queue
