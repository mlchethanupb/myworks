...
from stable_baselines import A2C, PPO2, TRPO, PPO2, ACKTR
...
def main(pa, args):
    ...
    parser.add_argument('--agent', type=str, nargs='?', const=1, default='ACKTR',
    ...
    default_objective = pa.objective_slowdown
...
if __name__ == '__main__':
    ...
    if args.agent == 'A2C' or args.agent == 'ACKTR' or args.agent == 'TRPO':
        tune_agent = A2C
        if args.agent == 'ACKTR':
            tune_agent = ACKTR
        elif args.agent == 'TRPO':
        ...
        best_agent.save(save_path + "Tuned_ACKTR")
