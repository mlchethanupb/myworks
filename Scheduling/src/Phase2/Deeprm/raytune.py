...
from stable_baselines import A2C, PPO2, TRPO , DQN
...
class CustomPolicy(FeedForwardPolicy):
    ...
    def __init__(self, *args, **kwargs):
        super(CustomPolicy, self).__init__(*args, **kwargs,
                                           net_arch=[dict(
                                               pi=[pa.network_input_width*pa.network_input_height, 20, pa.network_output_dim],
...
def main(pa, args):
    ...
    parser.add_argument('--agent', type=str, nargs='?', const=1, default='TRPO',
...
if __name__ == '__main__':
    ...
    if args.agent == 'A2C' or args.agent == 'PPO2' or args.agent == 'TRPO':
        ...
        best_agent.save(save_path + "Tuned_TRPO")
